...
<<<<<<< HEAD
>>>>>>> parent of eeddbc6 ( ready to publish)
=======
>>>>>>> parent of eeddbc6 ( ready to publish)
...
<<<<<<< HEAD
    ...
    data = st.sidebar.multiselect("select your data", df.columns.tolist())
    labels = st.sidebar.selectbox("select your labels", df.columns.tolist())
    if data and labels:
        with st.spinner('please wait...'):

            X_train, X_test, y_train, y_test = train_test_split(df[data], df[labels],\
...
>>>>>>> parent of eeddbc6 ( ready to publish)
    ...
    data=st.sidebar.multiselect("select your data", df.columns.tolist())
    labels=st.sidebar.selectbox("select your labels", df.columns.tolist())
    X_train, X_test, y_train, y_test = train_test_split(df[data], df[labels], test_size=0.2, random_state=1234)
